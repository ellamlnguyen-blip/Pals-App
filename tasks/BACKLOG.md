...
- TASK-015 notification inbox/preferences — bounded disposable-local planning contract and Proposed ADR-0017; implementation awaits reviewed canonical publication and explicit policy acceptance. See `active/TASK-015-notification-inbox-preferences.md`.
