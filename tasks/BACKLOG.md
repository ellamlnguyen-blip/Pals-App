...
- TASK-014 DM requests/direct chat — Accepted ADR-0016 permits bounded disposable-local stages after narrower contracts are reviewed/published. TASK-014A backend contract is prepared; implementation awaits its publication. See `active/TASK-014-dm-requests-direct-chat.md`.
