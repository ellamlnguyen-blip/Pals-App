...
- TASK-013 hangout chat — Accepted ADR-0015; reviewed local backend complete, UI contract pending publication/implementation. Realtime/global block/hosted access remain separate.
