...
- TASK-012 friendship — bounded local contract and ADR-0014 accepted; TASK-012A backend is dispatched on its isolated branch, and TASK-012B waits for reviewed integration. Friend-aware ranking, friends-only Hangout authorization and global block precedence remain separate.
