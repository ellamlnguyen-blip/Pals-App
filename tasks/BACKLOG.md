...
- TASK-015 notification inbox/preferences — Accepted ADR-0017; independently reviewed local backend stages A (ledger/social) and B (Hangout/chat events) complete. TASK-015C Notifications UI contract and visual plan are under independent security/design review before publication/dispatch. See `active/TASK-015-notification-inbox-preferences.md`.
