...
- TASK-015 notification inbox/preferences — Accepted ADR-0017; TASK-015A private ledger/social events complete for disposable-local scope after independent review. Hangout/chat source events (B) and UI (C) follow under separately published contracts. See `active/TASK-015-notification-inbox-preferences.md`.
