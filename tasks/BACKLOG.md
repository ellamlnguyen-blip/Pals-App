...
- TASK-015 notification inbox/preferences — Accepted ADR-0017 for disposable-local stages; TASK-015A ledger/social contract awaits independent review and canonical publication before fresh backend dispatch. Hangout/chat events and UI follow separately. See `active/TASK-015-notification-inbox-preferences.md`.
