...
4. `active/TASK-006-profile-enrichment.md` — owner-only profile editing/enrichment and photos authorized under ADR-0011, explicitly accepted 2026-09-22. Fresh implementation branch: `agent/TASK-006-profile-enrichment`; dispatch follows publication of this acceptance. Independent of TASK-005; no hosted operations. Planning handoff: `agents/handoffs/TASK-006-CONTRACT.md`.
