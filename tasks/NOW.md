...
3. `active/TASK-005-hangout-foundation.md` — resumed after explicit ADR-0010 approval (2026-09-22). Local backend-only implementation on `agent/TASK-005-hangout-foundation`; fresh agent dispatch follows published acceptance. Use the accepted joined-state roster; suspension revokes caller access without silently rewriting participation. No hosted changes/UI; TASK-007 waits for reviewed backend and safety gates. Preserve TASK-006 owner/profile/photo guards and TASK-003 hosted acceptance gap.
