...
4. `active/TASK-006-profile-enrichment.md` — owner-only profile editing/enrichment and photos authorized under ADR-0011, explicitly accepted 2026-09-22. Fresh implementation branch: `agent/TASK-006-profile-enrichment`; fresh implementation agent dispatched from verified main `fedf42c6a34fbf520f8823c675f99e4aa2ab42c3`. No implementation SHA published yet. Initial workspace check passed (13 unit tests and both builds); two clean database resets passed 112 pgTAP assertions each and schema lint. HTTP/concurrency/rendered verification and final review/integration remain outstanding. Independent of TASK-005; no hosted operations. Planning handoff: `agents/handoffs/TASK-006-CONTRACT.md`.
