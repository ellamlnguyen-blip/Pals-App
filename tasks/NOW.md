...
4. `active/TASK-006-profile-enrichment.md` — owner-only profile editing/enrichment and photos contract prepared; implementation blocked on explicit acceptance of Proposed ADR-0011. Independent of TASK-005; no hosted operations. Planning handoff: `agents/handoffs/TASK-006-CONTRACT.md`.
