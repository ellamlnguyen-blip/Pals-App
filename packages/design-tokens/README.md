...
TASK-004 adds map pin fill/ink/edge tokens, a shared overlay shadow and a menu layer (10). Mapbox owns its internal control layers; native modal dialogs use the browser top layer. App panels inherit light/dark semantic tokens. Pins intentionally retain a contrast-tested blue/white treatment across both basemaps.
