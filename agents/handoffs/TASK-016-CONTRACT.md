...
## Policy acceptance
On 2026-09-23 the user answered “yes” to accepting ADR-0018 as written for local-only implementation. The coordinator is preparing the narrower stage A contract for independent review/publication. Acceptance changes no schema, runtime gate or hosted environment.
