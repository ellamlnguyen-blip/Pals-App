...
## Next Milestone
TASK-005 backend, TASK-007 create/edit and TASK-008 saved map discovery/detail/joining are reviewed and locally verified under Accepted ADR-0010. Hangouts remain local-only with the database gate disabled by default. TASK-003 deployed HTTPS callback and public UNC email delivery, blocking/reporting/moderation and launch checks remain open. No automatic later-task implementation.
...
User requested the next task. Verified clean canonical main/origin at `e2e3b2d0b59d32100dfca91c04801b96d551f5ab`. Contract `tasks/active/TASK-009-calendar.md` consumes reviewed TASK-005/007/008 without schema or access expansion. Planned implementation branch `agent/TASK-009-calendar`; implementation/review pending. Today/Week campus-time views and authoritative joined/hosted filters remain local-only behind the default-disabled gate. Friend context, restricted access and all hosted safety/deployment gates stay deferred.
